...
ITINERARY = [
    ...
    dict(date=dt.date(2026, 9, 1), journee="Route aller vers la Cappadoce", nuit="Göreme", type="Route 🚗", trajet="~4h30 - 5h de route (≈350 km)"),
    dict(date=dt.date(2026, 9, 2), journee="Voyager Balloons", nuit="Göreme", type="Séjour 🏖️"),
    dict(date=dt.date(2026, 9, 3), journee="Back up Voyager Balloons", nuit="Göreme", type="Séjour 🏖️"),
